    ...
    <div className="space-y-8">
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          ...
          regarding VASH AI. Our dedicated support team is committed to
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm font-bold text-white">
                contact@novavoiceassistant.com
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium text-text-secondary uppercase tracking-wider">
              ...
              <span className="text-sm text-text-secondary font-light">
                218, Kimavati complex kim, 394110, Surat Gujarat
              </span>
            </div>
            <div className="pt-6 border-t border-white/10 mt-6">
              <p className="text-xs text-text-secondary flex items-center gap-2">
                <Clock className="w-4 h-4 text-primary" /> Response time: 24-48
                hours
              </p>
            </div>
          </div>
          ...
          >
            <div className="space-y-1.5">
              ...
              <input
                ...
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = "var(--primary-theme)";
                  e.currentTarget.style.boxShadow = `0 0 0 1px var(--primary-theme)`;
                }}
                onBlur={(e) => {
            ...
            <div className="space-y-1.5">
              ...
              <select
                required
                className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-opacity-100 focus:ring-1 transition-all appearance-none"
                style={{ borderColor: "rgba(255,255,255,0.1)" }}
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = "var(--primary-theme)";
                  e.currentTarget.style.boxShadow = `0 0 0 1px var(--primary-theme)`;
              ...
              >
                ...
                <option value="feature-request" className="bg-black text-white">
                  Feature Request
                </option>
                <option value="bug-report" className="bg-black text-white">
                  Bug Report
                </option>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-opacity-100 focus:ring-1 transition-all resize-none placeholder:text-white/20"
                style={{ borderColor: "rgba(255,255,255,0.1)" }}
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = "var(--primary-theme)";
                  e.currentTarget.style.boxShadow = `0 0 0 1px var(--primary-theme)`;
            ...
            <button
              type="submit"
              className="w-full py-4 text-black font-bold text-sm tracking-wide rounded-xl hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all mt-4"
              style={{ backgroundColor: "var(--primary-theme)" }}
            >
              Send Message
            </button>
    ...
    <div className="space-y-8">
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          ...
          <strong className="text-white font-medium">VASH AI</strong> software
          and services, you agree to be bound by these Terms and Conditions.
          These Terms constitute a legally binding agreement between you and
          <strong className="text-white font-medium"> VASH AI TECHNOLOGIES PRIVATE LIMITED</strong>.
        </p>
      </section>
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-white text-sm font-bold uppercase mb-2 tracking-wider">
              2.1 License Grant
            </h3>
            <p className="text-text-secondary font-light leading-relaxed text-base">
              Subject to these Terms, we grant you a limited, non-exclusive,
              non-transferable, revocable license to use VASH AI for personal or
              business purposes on devices you own.
            </p>
          </div>
          <div>
            <h3 className="text-white text-sm font-bold uppercase mb-2 tracking-wider">
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          ...
          ensuring device compatibility, and reporting security vulnerabilities
          or bugs immediately.
        </p>
      </section>
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <div className="space-y-4 text-text-secondary font-light leading-relaxed text-base">
          <p>
            All payments are processed securely through our PCI DSS compliant payment gateway (Razorpay). Access keys are
            generated ONLY after successful verification. Prices are in INR and include applicable taxes.
          </p>
          <p>
            We strictly enforce a policy not to store, hold, or copy any Customer&#39;s Payment Instrument credentials.
            Please refer to our Refund Policy for specific guidelines on returns and cancellations.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          VASH AI and the VADRYK engine are protected by copyright laws. We
          retain all rights, title, and interest in the software. Unauthorized
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          VASH AI is provided "as is" without warranties. We are not liable for
          any indirect or incidental damages arising from software usage.
        </p>
      </section>
    </div>
  );
  ...
  const privacyContent = (
    <div className="space-y-8">
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <p className="text-text-secondary font-light leading-relaxed text-base">
          At VASH AI, we prioritize your data sovereignty. Unlike standard
          assistants, our core processing is designed to remain{" "}
          <strong className="text-white font-medium">on-device</strong> whenever
          possible.
        </p>
      </section>
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
          <div
            ...
            style={{ backgroundColor: "var(--primary-theme)" }}
          ></div>
          Data Collection & Payment Information
        </h2>
        <ul className="list-disc list-inside space-y-4 text-text-secondary font-light leading-relaxed text-base">
          <li>
            <strong className="text-white font-medium">Personal Info:</strong>{" "}
            We only collect your email, name, and phone number necessary for processing your order and communicating updates.
          </li>
          <li>
            <strong className="text-white font-medium">Payment Data Security:</strong>{" "}
            We <strong>do not hold, store, copy, or keep any customer payment data</strong> relating to your Payment Instrument (such as full card number, CVV, expiry date, or PIN). All transactions are processed securely through our PCI DSS compliant Payment Aggregator.
          </li>
          <li>
            <strong className="text-white font-medium">Voice Data:</strong> Your
      ...
      <section className="bg-[#0a0a0a] border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden">
        <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
          <div
            ...
            style={{ backgroundColor: "var(--primary-theme)" }}
          ></div>
          Grievances & Nodal Officer
        </h2>
        <p className="text-text-secondary font-light leading-relaxed text-base mb-4">
          For any data protection concerns, complaints regarding content, customer grievances, or unauthorized use, please contact our Grievance Officer in writing:
        </p>
        <p className="text-text-secondary font-light leading-relaxed text-base">
          <strong className="text-white font-medium">Name:</strong> Praveen Parihar<br/>
          <strong className="text-white font-medium">Company:</strong> VASH AI TECHNOLOGIES PRIVATE LIMITED<br/>
          <strong className="text-white font-medium">Email:</strong> contact@novavoiceassistant.com
        </p>
      </section>
    </div>
  );
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      case AppScreen.WELCOME:
        return (
          <WelcomeScreen
            onContinue={() => navigateTo(AppScreen.HOME)}
      ...
      case AppScreen.HOME:
        return (
          <CompanyHomePage
            onViewProducts={() => navigateTo(AppScreen.OS_SELECTION)}
          />
        );
      ...
      case AppScreen.OS_FEATURES:
        return (
          <OSFeaturesScreen
            os={selectedOS}
            onBack={() => navigateTo(AppScreen.OS_SELECTION)}
            onContinue={() => navigateTo(AppScreen.MAIN_SELECTION)}
          />
        );
      ...
      case AppScreen.FEATURES:
        return (
          <FeaturesScreen
            onBack={() =>
              selectedOS
                ? navigateTo(AppScreen.MAIN_SELECTION)
      ...
      case AppScreen.PRODUCT_DETAILS:
        return activeProduct ? (
          <ProductDetailsPage
            ...
            onPurchase={(price, currency, qty) =>
              startPayment(price, currency, qty)
            }
