...
const ContactContent: React.FC<ContactContentProps> = ({ isHomePage = false }) => {
  ...
  return (
    <div className="space-y-6 md:space-y-8 px-4 md:px-0">
      <section className="p-2 md:p-4 mb-2 md:mb-6">
        <h2 className="text-3xl md:text-5xl font-display font-medium text-white mb-6 md:mb-8 tracking-tight">Get in Touch</h2>
        <p className="text-gray-400 font-light leading-relaxed text-base md:text-xl max-w-2xl">We're here to help you with any questions, concerns, or feedback regarding our services. Our dedicated support team is committed to providing you with the best possible assistance.</p>
      </section>
