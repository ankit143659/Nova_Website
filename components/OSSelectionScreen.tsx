  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-700 pb-24 font-sans max-w-7xl mx-auto px-4 sm:px-6 pt-12 md:pt-24 flex flex-col items-center justify-center min-h-[70vh]">
      ...
      <div className="grid grid-cols-1 select-none md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl mx-auto px-4">
        ...
        {/* Mac OS */}
        <div 
          className="group relative flex flex-col items-center text-center bg-[#09090b]/50 border border-white/[0.05] rounded-[2rem] p-8 cursor-not-allowed overflow-hidden transition-all duration-700 opacity-60 grayscale-[0.5]"
        >
          <div className="absolute top-4 right-4 bg-white/5 border border-white/10 p-2 rounded-full">
            <Lock className="w-4 h-4 text-gray-500" />
          </div>
          <div className="w-20 h-20 rounded-3xl bg-white/[0.02] border border-white/[0.05] flex items-center justify-center shadow-inner mb-6 mt-2">
            <Laptop className="w-10 h-10 text-gray-600" />
          </div>
          <h3 className="text-2xl font-display font-bold text-gray-500 mb-1 tracking-tight">macOS</h3>
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#ff2a6d]/80 mb-3 bg-[#ff2a6d]/5 px-3 py-1 rounded-full border border-[#ff2a6d]/10">Under Maintenance</span>
          <p className="text-gray-600 text-xs font-medium px-2 leading-relaxed italic">MJ Engine optimization in progress for Silicon architectures.</p>
        </div>
