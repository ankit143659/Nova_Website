  ...
  return (
    <div className="space-y-12 md:space-y-16 px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
        {[
          { icon: <Box className="w-6 h-6 text-emerald-400" />, title: 'No Physical Media', desc: 'We do not ship USB drives, CDs, or printed manuals. The entirety of the Nova AI platform is encapsulated in a streamlined digital format.' },
